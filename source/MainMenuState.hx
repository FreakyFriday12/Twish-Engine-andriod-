...
{
	public static var TwishEngineVersion:String = 'Nothing broken'; //This is also used for Discord RPC
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://youtube.com/channel/UCSCEwuAExtLzGTQUFfUefmg');
				}
				else
				{
					selectedSomethin = true;
